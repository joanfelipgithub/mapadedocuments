...
      <div style="font-size: 16px; margin-bottom: 8px;">🔍 **Activació de Cerca...**</div>
      <div style="font-size: 14px; opacity: 0.9;">Torna a **clicar el bookmarklet** un cop la pàgina s'hagi recarregat per construir el mapa.</div>
    `;
...
    
    // Injecta '_' i clica el botó amb un petit retard
    input.value = "_";
    
    setTimeout(() => {
      instructionNotif.remove(); // Neteja el missatge abans del clic
      searchBtn.click();
      console.log("🔍 Cerca activada. Torna a clicar el bookmarklet després de la recàrrega.");
    }, 1500); // Temps per llegir el missatge abans de la recàrrega
  } else {
